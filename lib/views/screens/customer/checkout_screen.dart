        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildDisabledOption("Redemption Card (Gifts Unavailable)", Icons.card_giftcard, isDark),
              ...
              Text("Selected Option: ${_selectedOption == 0 ? 'Delivery' : 'Pickup'}", style: AppTextStyles.interRegular(fontSize: 12, color: Colors.grey)),
              const SizedBox(height: 30),
              CustomButton(
      ...
      children: [
        Row(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Sushi lunch Combo", style: AppTextStyles.interBold(fontSize: 18)),
        ...
        Row(
          children: [
            ...
            Text("0/1 Members", style: AppTextStyles.interRegular(fontSize: 12)),
            const SizedBox(width: 16),
            const Icon(Icons.access_time, size: 16, color: Colors.grey),
            const SizedBox(width: 4),
            Text("Deadline: 2/10/2026", style: AppTextStyles.interRegular(fontSize: 12)),
          ],
        ),
        const SizedBox(height: 8),
        Row(
          children: [
            ...
            const SizedBox(width: 4),
            Text("Base Price: N16,000.00", style: AppTextStyles.interRegular(fontSize: 12)),
          ],
        ),
        const SizedBox(height: 16),
        ...
        Text("0.0% completion", style: AppTextStyles.interRegular(fontSize: 10, color: Colors.grey)),
      ],
    );
  }

  Widget _buildOptionCard(int index, String title, String subtitle, IconData icon, bool isDark) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? AppColors.primary : (isDark ? Colors.white10 : Colors.grey[200]!), width: 1.5),
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? AppColors.primary.withOpacity(0.1) : (isDark ? Colors.white10 : Colors.grey[50]),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(subtitle, style: AppTextStyles.interRegular(fontSize: 12, color: Colors.grey)),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16),
          Text(title, style: AppTextStyles.interMedium(fontSize: 14, color: Colors.grey.withOpacity(0.5))),
        ],
      ),
    );
  }
  ...
  Widget _buildSummaryRow(String label, String value, {bool isTotal = false}) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(label, style: isTotal ? AppTextStyles.interBold(fontSize: 16) : AppTextStyles.interRegular(fontSize: 14)),
          Text(
            value,
            style: isTotal
                ? AppTextStyles.interBold(fontSize: 18, color: AppColors.primary)
